...
namespace DBDesign.PosiStageDotNet.Client
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            {
                case 0:
                    client = new PsnClient(IPAddress.Parse("192.168.1.90"));
                    Console.WriteLine(
                        $"Listening on: default multicast IP: '{PsnClient.DefaultMulticastIp}', default port: {PsnClient.DefaultPort}, Set LocalIP: {client.IsListening}");
                    break;
